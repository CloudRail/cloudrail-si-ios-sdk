...
- (CRCharge * _Nullable)createChargeWithAmount:(NSInteger)amount currency:(NSString * _Nonnull)currency source:(CRCreditCard * _Nonnull)source error:(NSError * _Nullable * _Nullable)error;
- (CRCharge * _Nullable)chargeWithIdentifier:(NSString * _Nonnull)id error:(NSError * _Nullable * _Nullable)error;
- (NSMutableArray * _Nullable)listChargesFrom:(NSInteger)from to:(NSInteger)to creditCard:(CRCreditCard * _Nonnull)creditCard error:(NSError * _Nullable * _Nullable)error;
- (CRRefund * _Nullable)refundChargeWithIdentifier:(NSString * _Nonnull)id error:(NSError * _Nullable * _Nullable)error;
- (CRRefund * _Nullable)partiallyRefundChargeWithIdentifier:(NSString * _Nonnull)id amount:(NSInteger)amount error:(NSError * _Nullable * _Nullable)error;
- (CRRefund * _Nullable)refundWithIdentifier:(NSString * _Nonnull)id error:(NSError * _Nullable * _Nullable)error;
- (NSMutableArray * _Nullable)refundsForChargeWithIdentifier:(NSString * _Nonnull)id error:(NSError * _Nullable * _Nullable)error;
- (CRSubscriptionPlan * _Nullable)createSubscriptionPlanWithName:(NSString * _Nonnull)name amount:(NSInteger)amount currency:(NSString * _Nonnull)currency description:(NSString * _Nonnull)description interval:(NSString * _Nonnull)interval intervalCount:(NSInteger)intervalCount error:(NSError * _Nullable * _Nullable)error;
